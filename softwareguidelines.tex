...
\newcommand{\nine}{The root folder of the software project contains a file
	...
	\newcommand{\nineA}{The readme must start by explicitly mentioning the experimental nature of the software.}
    %^-- experimental
...
no further than a year away, and it should be reset regularly. \refcrit{SP1}}
    %^-- supported
	\newcommand{\nineC}{It must be mentioned explicitly that the software is unsupported }
    %^-- unsupported
