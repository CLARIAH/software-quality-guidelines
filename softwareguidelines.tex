...
We start in this document with the essentials: definitions and the state-of-art
...
from people in CLARIAH and beyond. The criteria and indicators will eventually
be published as an interactive survey as well. The idea is that developers can
self-assess their projects, and adopters of software can assess whether
software is of sufficient quality for their usage.
\end{TODO}
...
Please send your reply to proycon@anaproy.nl, reinier.de.valk@dans.knaw.nl and andrea.scharnhorst@dans.knaw.nl
\end{notice}
