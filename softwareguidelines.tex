...
passwords} \refcrit{SC2}; instead, it must use the federated authentication and group management facilities provided by the project.} %todo-jnj ik merk dat ik het gebruik van "the project" ambigu vindt. Kunnen we niet beter gewoon CLARIAH zeggen?
