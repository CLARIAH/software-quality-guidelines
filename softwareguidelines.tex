...
These guidelines for software quality consists of a several of assessment
...
The SSI has grouped assessment criteria as follows \cite{SSIGUIDE}.
...
indicators. There are inspired on the SSI guidelines but do not follow them
to the letter. Our indicators are generally more condensed, but some criteria
...
\indicator{BLD4 -- Are there tests to verify the build has succeeded?}
...
\indicator{IS8 -- There must be facilities to uninstall the software}
...
\indicator{PF1 -- Does the software perform its function(s) as efficient as can be expected?}
...
\indicator{CP2 i-- Is it clear who wrote the software, who owns the
...
\indicator{AC4 -- Are there clearly marked formal releases the software?}
...
\indicator{AC5 -- Are software releases deposited in a public
