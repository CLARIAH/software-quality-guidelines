...
\criterion{DOC1 -- Is there documentation?}
...
\criterion{DOC6 -- Does the documentation provide a high-level overview of the software?}

Documentation should offer a high-level overview of the software, rather
than immediately dive into the details.

\criterion{DOC7 -- Does the address the necessary audiences, at their appropriate levels?}
...
\criterion{DOC8 -- Does the documentation make use of adequate examples?}
...
\criterion{DOC9 -- Is there adequate troubleshooting information?}
...
\criterion{DOC10 -- Is the documentation available from the project website?}

Documentation must be clearly linked from the project website.

\criterion{DOC11 -- Is the documentation under version control?}
...
\criterion{LRN4 -- Is there API documentation for developers?}
...
\criterion{LRN5 -- If the software is configurable, are the configuration
...
\criterion{BLD1 -- Are there good instructions for building/compiling the software?}
...
\criterion{BLD2 -- Is an established automated build system used?}
...
\criterion{BLD3 -- Are all dependencies listed and available?}
(related to IS2)
...
\criterion{CP2 - Is it clear who wrote the software, who owns the
...
\criterion{COM1 - Is there evidence of the software being in use already by
...
\criterion{COM2 - Is there evidence of external developers independent of
...
\criterion{TST1 - Does the project have unit tests, is there sufficient coverage?}
...
\criterion{TST2 - Does the project have integration tests, is there sufficient coverage?}
...
\criterion{PTB1 - Is is clear for what platforms the software is written?}

It should be clear, from at least the project website, for what platforms the software
is intended.

\criterion{PTB2 - Is the software portable for multiple platforms?}
...
\criterion{PTB3 - Does the software work on multiple browsers?}
...
\criterion{SUP1 -- Is it clear whom to contact for support?}
...
\criterion{SUP2 -- Is there a public issue tracker?}
...
\criterion{SUP3 -- Is there a mailing list?}
...
\criterion{ANY1 -- Is the source code structured adequately?}
...
\criterion{ANY2 -- Is the source code commented adequately?}

The source code should contain comments explaining what major blocks do.

\criterion{ANY3 -- Do the comments generate API documentation?}
...
\criterion{ANL4 -- Is the source code cleanly laid out?}

The source code should follow a proper indentation convention. 

\criterion{ANL5 -- Are sensible names used?}
...
\criterion{CH4 -- Is the sofware sufficiently backwards-compatible?}
...
\criterion{IOP1 -- Does the software use appropriate open standards for data?}
...
\criterion{SEC1 -- Is the software free of obvious security flaws?}
...
\criterion{SEC2 -- Is user privacy secured effectively?}
