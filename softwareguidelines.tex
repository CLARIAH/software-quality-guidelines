...
\refcrit{U4}}
	\newcommand{\nineEight}{The readme must specify the commands used to build
...
\refcrit{L1}}
	\newcommand{\nineTen}{The readme must specify system requirements, i.e.\ observed
...
\newcommand{\twelveF}{the website must be registered on Google, and a link must
be provided to the project} %MvG: @jauco: Bedoel je met die laatste zin dat CLARIAH een link moet krijgen? Beter expliciet zeggen dan
