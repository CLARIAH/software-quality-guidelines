...
\criterion{\uOneName{ }--{ }\uOneText}\label{id:u1}
...
\criterion{\uTwoName{ }--{ }\uTwoText}\label{id:u2}
...
\criterion{\uThreeName{ }--{ }\uThreeText}\label{id:u3}
...
\criterion{\uFourName{ }--{ }\uFourText}\label{id:u4}
...
\criterion{\dOneName{ }--{ }\dOneText}\label{id:d1}
...
\criterion{\dTwoName{ }--{ }\dTwoText}\label{id:d2}
...
\criterion{\dThreeName{ }--{ }\dThreeText}\label{id:d3}
...
\criterion{\dFourName{ }--{ }\dFourText}\label{id:d4}
...
\criterion{\dFiveName{ }--{ }\dFiveText}\label{id:d5}
...
\criterion{\dSixName{ }--{ }\dSixText}\label{id:d6}
...
\criterion{\dSevenName{ }--{ }\dSevenText}\label{id:d7}
...
\criterion{\dEightName{ }--{ }\dEightText}\label{id:d8}
...
\criterion{\dNineName{ }--{ }\dNineText}\label{id:d9}
...
\criterion{\dTenName{ }--{ }\dTenText}\label{id:d10}
...
\criterion{\dElevenName{ }--{ }\dElevenText}\label{id:d11}
...
\criterion{\lOneName{ }--{ }\lOneText}\label{id:l1} %TODO italics!
...
\criterion{\lTwoName{ }--{ }\lTwoText}\label{id:l2} 
...
\criterion{\lThreeName{ }--{ }\lThreeText}\label{id:l3} 
...
\criterion{\lFourName{ }--{ }\lFourText}\label{id:l4} 
...
\criterion{\lFiveName{ }--{ }\lFiveText}\label{id:l5} 
...
\criterion{\bOneName{ }--{ }\bOneText}\label{id:b1} 
...
\criterion{\bTwoName{ }--{ }\bTwoText}\label{id:b2} 
...
\criterion{\bThreeName{ }--{ }\bThreeText}\label{id:b3}
...
\criterion{\bFourName{ }--{ }\bFourText}\label{id:b4} 
...
\criterion{\isOneName{ }--{ }\isOneText}\label{id:is1} 
...
\criterion{\isTwoName{ }--{ }\isTwoText}\label{id:is2} 
...
\criterion{\isThreeName{ }--{ }\isThreeText}\label{id:is3} 
...
\criterion{\isFourName{ }--{ }\isFourText}\label{id:is4} 
...
\criterion{\isFiveName{ }--{ }\isFiveText}\label{id:is5} 
...
\criterion{\isSixName{ }--{ }\isSixText}\label{id:is6} 
...
\criterion{\isSevenName{ }--{ }\isSevenText}\label{id:is7} 
...
\criterion{\isEightName{ }--{ }\isEightText}\label{id:is8} 
...
\criterion{\isNineName{ }--{ }\isNineText}\label{id:is9} 
...
\criterion{\pfOneName{ }--{ }\pfOneText}\label{id:pf1} 
...
\criterion{\pfTwoName{ }--{ }\pfTwoText}\label{id:pf2} 
...
\criterion{\pfThreeName{ }--{ }\pfThreeText}\label{id:pf3} 
...
\criterion{\pfFourName{ }--{ }\pfFourText}\label{id:pf4}
...
\criterion{\pfFiveName{ }--{ }\pfFiveText}\label{id:pf5} 
...
\criterion{\idOneName{ }--{ }\idOneText}\label{id:id1} 
...
\criterion{\idTwoName{ }--{ }\idTwoText}\label{id:id2} 
...
\criterion{\idThreeName{ }--{ }\idThreeText}\label{id:id3} 
...
\criterion{\cpOneName{ }--{ }\cpOneText}\label{id:cp1} 
...
\criterion{\cpTwoName{ }--{ }\cpTwoText}\label{id:cp2} 
...
\criterion{\cpThreeName{ }--{ }\cpThreeText}\label{id:cp3} 
...
\criterion{\acOneName{ }--{ }\acOneText}\label{id:ac1} 
...
\criterion{\acTwoName{ }--{ }\acTwoText}\label{id:ac2} 
...
\criterion{\acThreeName{ }--{ }\acThreeText}\label{id:ac3} 
...
\criterion{\acFourName{ }--{ }\acFourText}\label{id:ac4} 
...
\criterion{\acFiveName{ }--{ }\acFiveText}\label{id:ac5} 
...
\criterion{\acSixName{ }--{ }\acSixText}\label{id:ac6} 
...
\criterion{\acSevenName{ }--{ }\acSevenText}\label{id:ac7} 
...
\criterion{\cmOneName{ }--{ }\cmOneText}\label{id:cm1} 
...
\criterion{\cmTwoName{ }--{ }\cmTwoText}\label{id:cm2} 
...
\criterion{\cmThreeName{ }--{ }\cmThreeText}\label{id:cm3} 
...
\criterion{\tsOneName{ }--{ }\tsOneText}\label{id:ts1} 
...
\criterion{\tsTwoName{ }--{ }\tsTwoText}\label{id:ts2} 
...
\criterion{\tsThreeName{ }--{ }\tsThreeText}\label{id:ts3} 
...
\criterion{\tsFourName{ }--{ }\tsFourText}\label{id:ts4} 
...
\criterion{\pbOneName{ }--{ }\pbOneText}\label{id:pb1} 
...
\criterion{\pbTwoName{ }--{ }\pbTwoText}\label{id:pb2} 
...
\criterion{\pbThreeName{ }--{ }\pbThreeText}\label{id:pb3} 
...
\criterion{\spOneName{ }--{ }\spOneText}\label{id:sp1} 
...
\criterion{\spTwoName{ }--{ }\spTwoText}\label{id:sp2} 
...
\criterion{\anOneName{ }--{ }\anOneText}\label{id:an1} 
...
\criterion{\anTwoName{ }--{ }\anTwoText}\label{id:an2} 
...
\criterion{\anThreeName{ }--{ }\anThreeText}\label{id:an3} 
...
\criterion{\anFourName{ }--{ }\anFourText}\label{id:an4} 
...
\criterion{\anFiveName{ }--{ }\anFiveText}\label{id:an5} 
...
\criterion{\anSixName{ }--{ }\anSixText}\label{id:an6} 
...
\criterion{\anSevenName{ }--{ }\anSevenText}\label{id:an7} 
...
\criterion{\anEightName{ }--{ }\anEightText}\label{id:an8} 
...
\criterion{\chOneName{ }--{ }\chOneText}\label{id:ch1} 
...
\criterion{\chTwoName{ }--{ }\chTwoText}\label{id:ch2} 
...
\criterion{\chThreeName{ }--{ }\chThreeText}\label{id:ch3} 
...
\criterion{\chFourName{ }--{ }\chFourText}\label{id:ch4} 
...
\criterion{\chFiveName{ }--{ }\chFiveText}\label{id:ch5} 
...
\criterion{\chSixName{ }--{ }\chSixText}\label{id:ch6} 
...
\criterion{\rOneName{ }--{ }\rOneText}\label{id:r1} 
...
\criterion{\rTwoName{ }--{ }\rTwoText}\label{id:r2} 
...
\criterion{\rThreeName{ }--{ }\rThreeText}\label{id:r3} 
...
\criterion{\scOneName{ }--{ }\scOneText}\label{id:sc1} 
...
\criterion{\scTwoName{ }--{ }\scTwoText}\label{id:sc2} 
...
\criterion{\ipOneName{ }--{ }\ipOneText}\label{id:ip1} 
