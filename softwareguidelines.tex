...
\textbf{API must be discoverable}. For a Java project this means adding Javadoc
where needed, and using descriptive names otherwise. For Javascript this means
providing a document containing the API. What must be provided is a list of
...
expected to be called. \refcrit{L4}}
\newcommand{\sixteen}{If the software contains a configuration file, then the
root of the repository must contain a \textbf{configuration file containing all
options} set to the sane defaults or commented out containing a description
when you want to use them. \refcrit{L5}} %TODO-rdv deze snap ik niet
