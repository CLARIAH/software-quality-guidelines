...
% often useless.  Regarding D4 vs D6: No, I mean that the documentation should at
% least also offer a high-level view before it goes into the finer details, not that it
% should go beyond a high-level view (it should). Some rephrasing might be in
% order for D4 and D6 to make this clear?
...
%
% ^.
% <proycon@anaproy.nl> 2016-04-06: Yeah, I don't think so either..
...
obsolete. The decision form of installation that takes precedence should be
...
% > Changeability
%
% This seems very important to me. Contribution of outside parties can complicate sustainability, preservation, or even just keeping things under control, quite a bit.
%
% ^.
